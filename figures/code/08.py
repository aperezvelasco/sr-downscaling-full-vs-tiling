...
As Figure 7 but displaying the evaluation metrics for the best performing method
(Swin2SR) and the differences with other super-resolution methods (in columns UNet and 
DeepESD, from left to right) for the full-domain approach. Different evaluation metrics 
are displayed in rows: bias and RMSE, from top to bottom. The left column shows the 
actual values of the metrics for the Swin2SR method, whereas the second and third show 
differences of UNet and DeepESD relative to Swin2SR.
...
output_path = "/tmp/08.png"
filename = "predictions.nc"
varname = "t2m"
baseline_method = "Swin2SR"
