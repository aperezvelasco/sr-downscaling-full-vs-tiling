...
Performance comparison of super-resolution methods for the full-domain approach
across seasonal and annual metrics. This table presents the RMSE, MAE, Bias, SSIM, and 
PSNR values for different super-resolution methods, including Bicubic Interpolation, 
DeepESD (300M parameters), Swin2SR transformer (30M parameters), and UNet 
(30M parameters), evaluated across different seasons (DJF, JJA, MAM, SON) and annually.
"""

# Paths and config
methods_dict = {
    "Bicubic Interp.": "/home/pereza/data/phd/project/super-resolution/predictions/full-domain/bicubic/predictions.nc",
    "DeepESD": "/home/pereza/data/phd/project/super-resolution/predictions/full-domain/deepesd/predictions.nc",
    "Swin2SR": "/home/pereza/data/phd/project/super-resolution/predictions/full-domain/swin2sr/predictions.nc",
    "UNet": "/home/pereza/data/phd/project/super-resolution/predictions/full-domain/unet2d/predictions.nc",
}
target_path = "/home/pereza/data/phd/project/super-resolution/data/cerra/t2m/None/*.nc"
output_csv_path = "/tmp/01.csv"
variable = "t2m"
